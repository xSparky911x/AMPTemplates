...
'server start' )   docker compose down && docker-compose up && echo "WORLD: World initialized";;

'console' )  docker attach azerothcore-wotlk_ac-worldserver_1 && echo "disconnected from Worldserver.";;
